...
\projectinfo{
  ...
  % Abstrakt / Abstract
  abstract.cs={Tato práce se v úvodu zabývá modely víceúrovňové autentizace. Obsahuje základní informace o různých řešeních a dále se blíže zabývá modelem SSO v podobně standardu SAML a jeho implementací Shibboleth. Tato práce také obsahuje návody jak Shibboleth zprovoznit, napojit na různé poskytovatele identity a následně využít v kombinaci s Apache2.}, % abstrakt v českém či slovenském jazyce / abstract in czech or slovak language
  abstract.en={This work deals with multi-level authentication models in the introduction. It contains basic information about various solutions and further focuses on the SSO model in the form of the SAML standard and its implementation as Shibboleth. This work also includes instructions on how to set up Shibboleth, connect it to various identity providers, and use it in combination with Apache2.}, % abstrakt v anglickém jazyce / abstract in english
