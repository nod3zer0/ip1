...
\subsection{CMS} %IP@
Systém pro správu obsahu (CMS-Content Management System) je software zajišťující správu dokumentů, nejčastěji webového obsahu. % todo cite  https://cs.wikipedia.org/wiki/Syst%C3%A9m_pro_spr%C3%A1vu_obsahu
...
Je aplikace napsaná v php, která se stará o autentizaci a autorizaci pomocí SAML protokolu. Jedná se o jednu z nejrošířenějších opensource implmentací SAML protokolu.\\

Má jednoduché používání, dobrou dokumentaci a i spoustu pokročilejších funkcí.
%TODO citace https://simplesamlphp.org/
...
%TODO cite https://eulist.university/

\section{EduGAIN} %IP2

EduGAIN je služba co se stará o propojení již existujících federací poskytovatelů identity. Toto velmi ulehčí přidávání a odebírání nových poskytovatelů identity a služeb, jelikož není pak třeba vyměnit si metadata s každým poskytovatelem identity/služeb. Do Edugain se mohou přidat pouze celé \emph{federace}. \\%TODO: cite https://en.wikipedia.org/wiki/EduGAIN
%https://edugain.org/
...
%TODO citace https://www.eduid.cz/
...
Návod na instalaci SimpleSamlPHP lze nalézt na webových stránkách % TODO cite (https://simplesamlphp.org/docs/stable/simplesamlphp-install).
...
Více informací v dokumentaci. %(TODO: https://simplesamlphp.org/docs/stable/index.html)
...
Více informací lze nalézt v dokumentaci.%(TODO: https://simplesamlphp.org/docs/stable/simplesamlphp-sp)
\\
...
Mapování a filtrování atributů je dále podrobněji popsáno v dokumentaci SimpleSamlPHP. %(TODO citace: https://simplesamlphp.org/docs/stable/simplesamlphp-authproc.html)
...
Drupal je také opensource CMS napsaný v PHP, který je zaměřený na rozšířitelnost pomocí pluginů (Drupal je nazývá moduly). Jedná se o jedno z nejrozšířenějších CMS. Oproti Wordpresu má složitější používání.. Více informací lze nalézt na webových stránkách. %TODO cite
